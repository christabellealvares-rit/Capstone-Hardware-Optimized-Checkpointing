...
HD_PWD='C:/Users/Siren/OpenMSP430/OpenMSP430.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log openMSP430_fpga.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source openMSP430_fpga.tcl
